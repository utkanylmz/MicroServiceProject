...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        private ITopicClient createTopicClient()
        {
            ...
            // ensure that topic olready exists
        ...
        {
            var eventName = @event.GetType().Name;// example:OrderCreated
            eventName = ProcessEventName(eventName); // example:OrderCreated IntegrationEvent
        ...
        private Task ExceptionReceivedHandler(ExceptionReceivedEventArgs exceptionReceivedEventArgs)
        {
            ...
            logger.LogError(ex, "ERROR handling message:[Exception Message}-Context:(@ExceptionContext]", ex.Message, context);
