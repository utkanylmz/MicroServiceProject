...
namespace CatalogService.Api.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        //Http Get metodu geriye PaginatedItemsViewModel veya IEnumerable<CatalogItem> dönersek 200 kodu veya BadRequest dönebiliriz.
        ...
        //Idlere göre kayıtları çekmek için 
        ...
        [ProducesResponseType(typeof(PaginatedItemsViewModel<CatalogItem>), (int)HttpStatusCode.OK)]
        //Dışardan bir brand id type id gönderildiğinde ürünleri listelemek için
